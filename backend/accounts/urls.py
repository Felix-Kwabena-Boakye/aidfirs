...
from .views import (
    ...
    AuditLogView, GoogleOAuthView, TokenRefreshView,
    ResetUserPasswordView, ChangePasswordView
)
...
urlpatterns = [
    ...
    path('users/<str:user_id>/reset-password/', ResetUserPasswordView.as_view(), name='user_reset_password'),
